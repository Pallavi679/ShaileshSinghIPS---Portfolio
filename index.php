  ...
  ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="section-header">
                        <img src="./img/img/icon.png" alt="" srcset="">
                        <h2>About Me </h2>
                    </div>
        ...
        <div class="container">
            ...
            <div class="container mt-4 d-flex justify-content-center">
                <div class="row g-0">
                    ...
                    <div class="col-md-6 border-right">
                        <div class="cards">
                            <div class=" second bg-white p-4 text-center"> <img src="./img/img/PREM.png" />
            ...
            <div class="owl-carousel testimonials-carousel">
                <div class="testimonial-item">
                    ...
                    <p>
                        ...
                        egestas eleifend dui ac consequat
                    </p>
                    <h2>Client Name</h2>
                    <h3>Profession</h3>
                </div>
                <div class="testimonial-item">
                    ...
                    <p>
                        ...
                        non velit. Vivamus vehicula finibus
                    </p>
                    <h2>Client Name</h2>
                    <h3>Profession</h3>
                </div>
    ...
    <div class="blog">
        <div class="container">
            <div class="section-header">
                <p>Firm Beliver</p>
                <h2>Bhagat Singh | Freedom Fighter</h2>
            </div>
            <div class="owl-carousel blog-carousel">
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="./img/img/bhagatsingh.jpg" alt="Blog">
                    </div>
                    <div class="blog-content">
                        <h2 class="blog-title text-center">I am such a lunatic that I am free even in jail</h2>
                        <div class="blog-meta">
                ...
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="./img/img/qoutes2.jfif" alt="Blog">
                    </div>
                    <div class="blog-content">
                        <h2 class="blog-title text-center">मेरा धर्म देश की सेवा करना है।</h2>
                        <div class="blog-meta">
                            <i class="fa fa-list-alt"></i>
                            <a href="">Motivation</a>
                            <i class="fa fa-calendar-alt"></i>
